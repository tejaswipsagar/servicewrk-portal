...
export const GetAllPartnerUserForTicketFilter = {
  data() {
    return {
      noDataText: "",
      overlay: false,
  ...
  methods: {
    async GetAllPartnerUserForTicketFilterMethod(
      user_type,
      user_status,
      partner_id
    ) {
      try {
        ...
        this.GetAllPartnerAndPartnerUserListForTicketFilter = JSON.parse(
        ...
        if (
          ...
          this.GetAllPartnerAndPartnerUserListForTicketFilter.unshift({
            user_name: "ALL",
            user_id: "ALL",
            partner_id: "ALL",
          });
