...
export default {
  ...
  async mounted() {
    const response = await fetch(
      "https://servicewrkcabinet.s3.ap-south-1.amazonaws.com/ServiceWRK_Customers/e3bcefad-4b74-476a-80ec-2a602fd30434/Customers/abc_enterprise.json"
    );
    const data = await response.json(); // Use .text() for .txt files
    console.log("REST_API_CUST_DTA", data);
    ...
    console.log("CHECK_RFS_DATA_IN_CUSTOMER", a);
    if (
