      ...
      <v-toolbar flat dense>
        <div class="largeFontSizeNew mt-n4 ml-0">
          ...
          <span v-if="isSearching == false">
            <span v-if="SettingStatus == 'TAGGED'">{{
              this.tagged_serial_numbers
            }}</span>
            <span v-else-if="SettingStatus == 'ACTIVE'">{{
              this.un_tagged_serial_numbers
            }}</span>
            <span v-else-if="SettingStatus == 'INACTIVE'">{{
        ...
        <v-select
          ...
          class="mx-1 mt-n1 widthSmall FontSize"
      ...
      <v-card flat>
        ...
        >
          ...
          <template v-slot:[`item.category_name`]="{ item }">
            ...
            <div v-else>-</div>
            <div class="FontSize" v-if="SettingStatus == 'INVALID'">
              {{ item.customer_name }}
            </div>
          </template>
          <template v-slot:[`item.setting_name`]="{ item }">
            <div class="FontSize" v-if="item.setting_name != undefined">
              ...
              <v-icon
                ...
                v-if="SettingStatus == 'ACTIVE'"
                @click.stop="
                  checkItem(item, 'PRODUCT_FLEET_TRANSFERRED_HISTORY')
                "
            ...
            <div
              class="FontSize"
              v-if="
                item.product_aging != undefined &&
                item.product_aging != '' &&
                parseInt(item.product_aging) >= 0
              "
            >
              {{ getAge(item.product_aging) }}
            </div>
            <div v-else>-</div>
          ...
          <template v-slot:[`item.customer_name`]="{ item }">
            <div
              class="FontSize"
              v-if="
                item.customer_company_name != undefined &&
          ...
          >
            ...
            <div
              v-if="
                item.representative_name != undefined &&
                    ...
                    >
                      <v-list-item-icon>
                        <v-icon
                          small
                          :color="
                            item.setting_status == 'ACTIVE' ? 'red' : 'green'
                          "
                          >{{
                            item.setting_status == "ACTIVE"
                              ? "mdi-close-thick"
...
export default {
  ...
  async mounted() {
    ...
    this.FilteringArray = await this.getUserProductFleet();
  },
  methods: {
    exporttoexcel() {
      if (this.SettingStatus == "INVALID") {
        ...
        console.log("this.FilteringArray", this.FilteringArray);
        const customerDetailsMapped = new Map(this.FilteringArray);
        console.log("customerDetailsMapped", customerDetailsMapped);
