            ...
            <v-col cols="12" md="7" sm="12" xs="12">
              ...
              <v-row class="mt-2">
                <v-col cols="12" md="4" sm="12" xs="12" class="mt-1">
                  <p class="ml-3 FontSize" v-if="enable_discount">
                    Total : {{ this.sub_total_amount }}
                  </p>
                </v-col>
                <v-col cols="12" md="3" sm="12" xs="12">
                  <v-text-field
                    ...
                    class="FontSize"
                    @input="calculate_discount(discount_percentage)"
                    >OtheropenPanel
                  </v-text-field>
                </v-col>
...
export default {
  ...
  data: () => ({
    ...
    productsPriviewHeaders: [
      ...
      { text: "Price", value: "price" },
      { text: "Qty", value: "quantity", width: "100px" },
      { text: "GST %", value: "gst" },
      { text: "Total", value: "per_component_total_amount" },
        ...
        this.components_list.forEach((item) => {
          ...
          if (this.enable_discount === true) {
            this.total_amount =
              ...
              this.sub_total_amount * (this.discount_percentage / 100);
          } else {
      ...
      if (
        ...
        try {
          ...
          var inputParams = {
            ...
            sub_total_amount: parseFloat(this.sub_total_amount),
            discount_percentage:
              this.enable_discount === true
                ? parseFloat(this.discount_percentage) || 0
                : 0,
            // discount_percentage:
            //   this.discount_percentage != undefined &&
            //   this.discount_percentage != null
            //     ? parseFloat(this.discount_percentage)
            //     : 0,
            ...
            discount_amount:
              this.enable_discount === true
                ...
                : 0,
            // discount_amount:
            //   this.discount_amount != undefined && this.discount_amount != null
