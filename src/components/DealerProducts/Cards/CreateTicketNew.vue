...
export default {
  ...
  mounted() {
    ...
    console.log("CREATE_TICKET", this.create_ticket);
  },
  methods: {
    validateMethod() {
    ...
    async CreateAssignedTicket() {
      try {
          ...
          graphqlOperation(mutationName, {
            input: (() => {
              if (this.settingEnabled) {
                let Local_Array = [];
                let Object = {
                  category_id: this.create_ticket.category_id || undefined,
                  service_id: this.create_ticket.service_id || undefined,
                  service_serial_number:
                ...
                return {
                  ...
                  source_remark: this.create_ticket.source_remark || undefined,

                  ticket_call_source:
                    this.create_ticket.ticket_call_source || undefined,
                  ticket_pincode:
                    this.create_ticket.ticket_pincode || undefined,
                  ticket_state: this.create_ticket.ticket_state || undefined,
                  ticket_city: this.create_ticket.ticket_city || undefined,
                  secondary_customer_contact:
        ...
        const ResultObject = JSON.parse(result.data[mutationNameString]);
