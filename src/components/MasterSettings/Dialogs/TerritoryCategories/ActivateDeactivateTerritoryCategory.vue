<template>
    <div>
      ...
      <v-dialog
        :value="ActivateDeactivateTerritoryCategoryDialog"
        persistent
        max-width="400px"
      >
        <v-card>
          <v-toolbar dark dense class="elevation-0" color="primary">
            ...
            <v-btn
              icon
              @click="ActivateDeactivateTerritoryCategoryDialogEmit((Toggle = 1))"
  ...
  import { ActivateORDeactivateTerritoryType } from "@/graphql/mutations.js";
  import Snackbar from "@/components/Extras/SnackbarView.vue";
  export default {
    props: {
      StoreObj: Object,
      ActivateDeactivateTerritoryCategoryDialog: Boolean,
    },
    components: {
      Snackbar,
    },
    ...
    methods: {
      async activateInactivateMethod() {
        var mutationname = ActivateORDeactivateTerritoryType;
        var mutationresult = "ActivateORDeactivateTerritoryType";
        var inputParams = {
        ...
        try {
          ...
          if (ResultObject.status == "SUCCESS") {
            ...
            this.ActivateDeactivateTerritoryCategoryDialogEmit((this.Toggle = 2));
          }
          this.loading = false;
        } catch (error) {
          this.loading = false;
