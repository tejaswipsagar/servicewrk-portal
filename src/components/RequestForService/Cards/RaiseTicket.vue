    ...
    <v-card flat>
      <v-window v-model="step">
        <v-window-item :value="1">
          <v-card-text>
            <div class="black--text font-weight-bold">Customer Information</div>
            <RFSWindow1 :StoreObj="StoreObj" />
            <v-spacer />
            <div class="d-flex justify-end mt-3">
              <div>
                <v-btn dense small>Back</v-btn>
              </div>
              <div class="ml-2">
                <v-btn dense small color="primary" @click="step = 2"
                  >Next</v-btn
                >
              </div>
            </div>
        ...
        <v-window-item :value="2">
          <v-card-text>
            <div class="black--text font-weight-bold">Service Information</div>
            <Windowpage2
            ...
            <div class="d-flex justify-end mt-3">
              <div>
                <v-btn dense small @click="step = 1">Back</v-btn>
              </div>
              <div class="ml-2">
                <v-btn dense small color="primary" @click="step = 2"
                  >Next</v-btn
      ...
      <v-card-text>
        <v-window v-model="stepperPage">
          <v-window-item :value="1">
            <v-form ref="form1">
              <Windowpage1 @clicked="windowPage1Emit" />
            </v-form>
          </v-window-item>
          <v-window-item :value="2">
            <v-form ref="form2">
...
import RFSWindow1 from "@/components/RequestForService/Cards/Window/RFSWindow1.vue";
