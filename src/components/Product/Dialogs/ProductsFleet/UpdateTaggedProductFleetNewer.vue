      ...
      <v-card>
        <v-toolbar dark dense class="elevation-0" color="primary">
          <div>
            ...
            <span>{{ currentProductDetails[0]?.setting_name }}</span>
          </div>
          <v-spacer></v-spacer>
...
export default {
  ...
  watch: {
    ...
    async AddUpdateProductFleetDialog(val) {
      if (val == true) {
        console.log(
        ...
        this.currentProductDetails =
          await this.getParticularProdFleetDataMethod(
            this.StoreObjForTaggedProductFleet.setting_id
          );
        this.rft_date_list = this.currentProductDetails[0].rft_date_list;
        ...
        this.product_name = this.currentProductDetails[0].product_name;
        this.product_sl_no =
          this.currentProductDetails[0].setting_name != undefined
            ? this.currentProductDetails[0].setting_name
            : this.currentProductDetails[0].product_sl_no;
        this.invoice_number =
          this.currentProductDetails[0].invoice_number != undefined
        ...
        this.product_purchased_on =
          this.currentProductDetails[0].product_purchased_on != "-"
            ? this.currentProductDetails[0].product_purchased_on
            : "";
        this.product_price = this.currentProductDetails[0].setting_price;
        this.product_description =
          this.currentProductDetails[0].setting_description;
        this.asset_number = this.currentProductDetails[0].asset_number;
        this.software_version = this.currentProductDetails[0].software_version;
        ...
        this.warranty_end_date =
          this.currentProductDetails[0].warranty_end_date != "-"
            ...
            : "";
        this.support_type =
          this.currentProductDetails[0].support_type != undefined
            ? this.currentProductDetails[0].support_type.includes(" ")
              ? this.currentProductDetails[0].support_type.replace(" ", "_")
        ...
        this.ticket_frequency =
          this.currentProductDetails[0].ticket_frequency != undefined
            ? this.currentProductDetails[0].ticket_frequency
            : this.currentProductDetails[0].frequency;
        this.s3_files =
  ...
  methods: {
    ...
    async activateInactivateMethod() {
      ...
      var inputParams = {
        ...
        customer_id: this.currentProductDetails[0].customer_id,
        product_id: this.currentProductDetails[0].product_id,
